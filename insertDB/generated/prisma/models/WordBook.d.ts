...
export type GetWordBookAggregateType<T extends WordBookAggregateArgs> = {
    [P in keyof T & keyof AggregateWordBook]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateWordBook[P]> : Prisma.GetScalarType<T[P], AggregateWordBook[P]>;
};
...
type GetWordBookGroupByPayload<T extends WordBookGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<WordBookGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof WordBookGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], WordBookGroupByOutputType[P]> : Prisma.GetScalarType<T[P], WordBookGroupByOutputType[P]>;
}>>;
...
export type WordBookCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<WordBookFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface WordBookDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * })
    **/
    count<T extends WordBookCountArgs>(args?: Prisma.Subset<T, WordBookCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], WordBookCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends WordBookGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, WordBookGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetWordBookGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export {};
//# sourceMappingURL=WordBook.d.ts.map